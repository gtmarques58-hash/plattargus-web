...
TEMPLATES_META = {
    ...
    "MEMO_GENERICO": {
        ...
        "tipo_sei": "Memorando",
        "descricao": "Memorando genérico para qualquer finalidade",
        "campos": [
    ...
    "MEMO_TAF_DEI": {
        ...
        "tipo_sei": "Memorando",
        "descricao": "Memorando para DEI sobre TAF (condição clínica, isenção)",
        "campos": [
            "NOME_DESTINATARIO", "POSTO_GRAD_DESTINATARIO", "CARGO_DESTINATARIO",
    ...
    "MEMO_DIARIAS": {
        ...
        "tipo_sei": "Memorando",
        "descricao": "Memorando sobre diárias para DPLAN",
        "campos": [
            "NOME_DESTINATARIO", "POSTO_GRAD_DESTINATARIO", "CARGO_DESTINATARIO",
    ...
    "OFICIO_CONVOCACAO_FERIAS": {
        ...
        "tipo_sei": "Ofício",
        "descricao": "Ofício de convocação para agendamento de férias pendentes",
        "campos": [
    ...
    "REQ_GENERICO": {
        ...
        "descricao": "Requerimento genérico para qualquer solicitação",
        "campos": [
    ...
    "REQ_LICENCA_NUPCIAS": {
        ...
        "tipo_sei": "Requerimento",
        "descricao": "Requerimento de licença por motivo de núpcias (casamento)",
        "campos": [
    ...
    "REQ_LICENCA_PATERNIDADE": {
        ...
        "tipo_sei": "Requerimento",
        "descricao": "Requerimento de licença paternidade",
        "campos": [
            "NOME_COMANDANTE", "CARGO_COMANDANTE", "NOME_REQUERENTE",
            "POSTO_GRAD_REQUERENTE", "MATRICULA", "UNIDADE_LOTACAO",
    ...
    "REQ_LICENCA_MATERNIDADE": {
        ...
        "tipo_sei": "Requerimento",
        "descricao": "Requerimento de licença maternidade (180 dias)",
        "campos": [
            "NOME_COMANDANTE", "CARGO_COMANDANTE", "NOME_REQUERENTE",
            "POSTO_GRAD_REQUERENTE", "MATRICULA", "UNIDADE_LOTACAO",
            "DATA_NASCIMENTO"
    ...
    "REQ_ADICIONAL_TITULACAO": {
        ...
        "tipo_sei": "Requerimento",
        "descricao": "Requerimento de adicional de titulação",
        "campos": [
            "NOME_COMANDANTE", "CARGO_COMANDANTE", "NOME_REQUERENTE",
            "POSTO_GRAD_REQUERENTE", "MATRICULA", "UNIDADE_LOTACAO",
    ...
    "REQ_INCLUSAO_DEPENDENTE": {
        ...
        "tipo_sei": "Requerimento",
        "descricao": "Requerimento de inclusão no ROL de dependentes",
        "campos": [
            "NOME_COMANDANTE", "CARGO_COMANDANTE", "NOME_REQUERENTE",
            "POSTO_GRAD_REQUERENTE", "MATRICULA", "UNIDADE_LOTACAO",
    ...
    "DESPACHO_ENCAMINHAMENTO": {
        ...
        "tipo_sei": "Despacho",
        "descricao": "Despacho de encaminhamento para providências",
        "campos": [
            "CARGO_DESTINATARIO", "SIGLA_UNIDADE_DESTINATARIO", "VOCATIVO",
    ...
    "DESPACHO_CIENCIA_ARQUIVAMENTO": {
        ...
        "tipo_sei": "Despacho",
        "descricao": "Despacho de ciência e arquivamento",
        "campos": [
            "NOME_REMETENTE", "POSTO_GRAD_REMETENTE", "CARGO_REMETENTE",
            "SIGLA_UNIDADE"
        ],
    ...
    "NOTA_BG_VIAGEM": {
        ...
        "descricao": "Nota para BG sobre viagem a serviço da corporação",
        "campos": [
    ...
    "NOTA_BG_GENERICA": {
        ...
        "tipo_sei": "Nota para Boletim Geral - BG - CBMAC",
        "descricao": "Nota genérica para Boletim Geral",
        "campos": [
    ...
    # ==========================================================================
    "TERMO_ENCERRAMENTO": {
        "arquivo_path": MODELOS_DIR / "termos" / "TERMO_ENCERRAMENTO.txt",
        ...
        "campos": [
            "DIA", "MES", "ANO", "MOTIVO_ENCERRAMENTO", "NOME_RESPONSAVEL",
    ...
    "PORTARIA_COMISSAO": {
        ...
        "tipo_sei": "Portaria",
        "descricao": "Portaria de nomeação de comissão",
        "campos": [
...
def get_template_info(template_id: str) -> dict:
    """Retorna informações de um template específico"""
    return TEMPLATES_META.get(template_id)


def template_existe(template_id: str) -> bool:
    """Verifica se o template existe e o arquivo está acessível"""
...
def get_campos_obrigatorios(template_id: str) -> list:
    """Retorna lista de campos obrigatórios de um template"""
...
def validar_dados_template(template_id: str, dados: dict) -> tuple:
    ...
    Retorna (True, []) se válido, ou (False, [campos_faltantes]) se inválido.
    """
...
# =============================================================================
# RESUMO DOS TEMPLATES DISPONÍVEIS
# =============================================================================
"""
MEMORANDOS (4):
...
- MEMO_DIARIAS: Memorando sobre diárias para DPLAN

OFÍCIOS (2):
- OFICIO_EXTERNO: Ofício para órgãos externos
- OFICIO_CONVOCACAO_FERIAS: Ofício de convocação para férias pendentes

REQUERIMENTOS (7):
- REQ_GENERICO: Requerimento genérico
- REQ_LICENCA_NUPCIAS: Requerimento de licença por núpcias
- REQ_DISPENSA_LUTO: Requerimento de dispensa por luto
- REQ_LICENCA_PATERNIDADE: Requerimento de licença paternidade
- REQ_LICENCA_MATERNIDADE: Requerimento de licença maternidade
- REQ_ADICIONAL_TITULACAO: Requerimento de adicional de titulação
- REQ_INCLUSAO_DEPENDENTE: Requerimento de inclusão de dependente

DESPACHOS (5):
- DESPACHO_SIMPLES: Despacho com texto livre
- DESPACHO_ENCAMINHAMENTO: Despacho de encaminhamento
- DESPACHO_CIENCIA_ARQUIVAMENTO: Despacho de ciência e arquivamento
- DESPACHO_DEFERIMENTO: Despacho de deferimento
- DESPACHO_INDEFERIMENTO: Despacho de indeferimento

NOTAS PARA BG (2):
- NOTA_BG_VIAGEM: Nota sobre viagem a serviço
- NOTA_BG_GENERICA: Nota genérica para BG

TERMOS (1):
- TERMO_ENCERRAMENTO: Termo de encerramento de processo

PORTARIAS (2):
- PORTARIA_COMISSAO: Portaria de nomeação de comissão
- PORTARIA_GENERICA: Portaria genérica
