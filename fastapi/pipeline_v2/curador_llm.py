"""
CURADOR LLM - Pipeline v2.0 (Standalone para FastAPI)
============================
...
PROMPT_CURADOR = """Voce e um curador de processos administrativos. Selecione os 8-12 documentos ESSENCIAIS.
...
## CRITERIOS:
1. SEMPRE INCLUIR: Demandante (1o doc), Despachos CMDGER/SUBCMD, Memorandos, Portarias
2. INCLUIR SE RELEVANTE: Pareceres, Oficios externos (PMAC, SEAD)
3. EXCLUIR: Encaminhamentos repetitivos, Anexos sem merito
